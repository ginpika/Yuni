const i18n = {
    ...
    translations: {
        zh: {
            ...
            clear: '清空',
            clearConfirm: '清空确认',
            clearConfirmDesc: '确定要清空当前会话吗？',
            clearWarning: '此操作将删除当前会话的所有消息记录，且无法恢复。',
            deleteSessionTitle: '删除会话',
            deleteSessionMessage: '确定要删除此会话吗？此操作无法撤销。',
            ...
            browserPermissionRequest: '浏览器访问请求',
            aiBrowserRequest: 'AI 请求访问网站',
            domain: '域名：',
            url: 'URL：',
            rememberDomain: '记住此域名（加入白名单）',
            reject: '拒绝',
            allow: '允许',
        ...
        en: {
            ...
            clearConfirmDesc: 'Are you sure you want to clear this session?',
            clearWarning: 'This will delete all messages in the current session and cannot be undone.',
            ...
            browserPermissionRequest: 'Browser Access Request',
            aiBrowserRequest: 'AI requests to access website',
            domain: 'Domain:',
            url: 'URL:',
            rememberDomain: 'Remember this domain (add to whitelist)',
            reject: 'Reject',
            allow: 'Allow',
